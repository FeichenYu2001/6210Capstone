...
function BuildResume(props) {
  ...
  const changeAddEdu = () => setAddEdu(true);
  const changeAddExp = () => setAddExp(true);
  const changeAddSkill = () => setAddSkill(true);
  const changeAddProject = () => setAddProject(true);
  const changeAddAchievement = () => setAddAchievement(true);
