          ...
          <div className="card p-4">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group mb-3">
                ...
                <input type="text" name="skillSet" value={formData.skillSet} onChange={handleChange} className="form-control" required />
              </div>

              <div className="form-group mb-3">
                <label>Perks (Optional)</label>
                <input type="text" name="perks" value={formData.perks} onChange={handleChange} className="form-control" />
              </div>
              ...
              <div className="form-group mb-3">
                ...
                <input type="number" name="maxApplications" value={formData.maxApplications} onChange={handleChange} className="form-control" required />
              </div>

              <div className="form-group mb-3">
                <label>Positions Available</label>
                <input type="number" name="positions" value={formData.positions} onChange={handleChange} className="form-control" required />
              </div>
              ...
              <div className="form-group mb-4">
                ...
                <select name="jobType" value={formData.jobType} onChange={handleChange} className="form-control" required>
